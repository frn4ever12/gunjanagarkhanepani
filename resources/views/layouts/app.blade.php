...
<head>
    ...
    <title>@yield('title', 'गुन्जनगर खानेपानी आयोजना - स्वच्छ पानी, स्वस्थ जीवन')</title>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 logo-section d-flex align-items-center">
                    ...
                    <div class="logo-text">
                        ...
                        <p class="office-address"><i class="fas fa-map-marker-alt me-1"></i>{{ Setting::get('office_address') }}</p>
                        @endif
                    </div>
                </div>
                <div class="col-md-6 text-end header-buttons">
                    <div class="header-contact-info">
                        ...
                        <p class="header-phone"><i class="fas fa-phone me-1"></i>{{ Setting::get('contact_phone') }}</p>
                        @endif
                        @if(Setting::get('contact_email'))
                        <p class="header-email"><i class="fas fa-envelope me-1"></i>{{ Setting::get('contact_email') }}</p>
                        @endif
                        @if(Setting::get('office_address'))
                        <p class="header-address"><i class="fas fa-map-marker-alt me-1"></i>{{ Setting::get('office_address') }}</p>
                        @endif
                    </div>
                </div>
            </div>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('about') }}">हाम्रो बारेमा</a></li>
                            <li><a class="dropdown-item" href="{{ route('board-of-directors') }}">सञ्चालक समिति</a></li>
                            <li><a class="dropdown-item" href="{{ route('organizational-structure') }}">संगठनात्मक संरचना</a></li>
                            <li><a class="dropdown-item" href="{{ route('staff') }}">कर्मचारी विवरण</a></li>
                            <li><a class="dropdown-item" href="{{ route('office-hours') }}">कार्यालय समय</a></li>
                            <li><a class="dropdown-item" href="{{ route('citizen-charter') }}">नागरिक वडापत्र</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('services') }}">खानेपानी सेवा</a></li>
                            <li><a class="dropdown-item" href="{{ route('services.new-connection') }}">नयाँ धारा जडान</a></li>
                            <li><a class="dropdown-item" href="{{ route('services.transfer') }}">धारा स्थानान्तरण</a></li>
                            <li><a class="dropdown-item" href="{{ route('services.maintenance') }}">धारा मर्मत</a></li>
                            <li><a class="dropdown-item" href="{{ route('services.water-quality') }}">पानीको गुणस्तर</a></li>
                            <li><a class="dropdown-item" href="{{ route('services.information') }}">सेवा सम्बन्धी जानकारी</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('e-services*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            ई-सेवाहरू
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('e-services.forms') }}">अनलाइन फारमहरू</a></li>
                            <li><a class="dropdown-item" href="{{ route('downloads') }}">डाउनलोड केन्द्र</a></li>
                            <li><a class="dropdown-item" href="{{ route('complaint') }}">गुनासो / सुझाव</a></li>
                            <li><a class="dropdown-item" href="{{ route('contact') }}">सम्पर्क गर्नुहोस्</a></li>
                            <li><a class="dropdown-item" href="{{ route('notices') }}">महत्वपूर्ण सूचना</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('resources*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            श्रोतहरू
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('downloads') }}">डाउनलोड</a></li>
                            <li><a class="dropdown-item" href="{{ route('forms') }}">फारमहरू</a></li>
                            <li><a class="dropdown-item" href="{{ route('annual-reports') }}">वार्षिक प्रतिवेदन</a></li>
                            <li><a class="dropdown-item" href="{{ route('rules-regulations') }}">नियमावली</a></li>
                            <li><a class="dropdown-item" href="{{ route('policies') }}">नीति तथा निर्देशिका</a></li>
                            <li><a class="dropdown-item" href="{{ route('publications') }}">प्रकाशनहरू</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('notices*') || request()->routeIs('news*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            सूचना
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('notices') }}">सूचना</a></li>
                            <li><a class="dropdown-item" href="{{ route('news') }}">समाचार</a></li>
                            <li><a class="dropdown-item" href="{{ route('press-releases') }}">प्रेस विज्ञप्ति</a></li>
                            <li><a class="dropdown-item" href="{{ route('public-notices') }}">सार्वजनिक सूचना</a></li>
                            <li><a class="dropdown-item" href="{{ route('notice-archive') }}">सूचना संग्रह</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('vacancy*') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            पदपूर्ति
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('vacancy') }}">रोजगारी सूचना</a></li>
                            <li><a class="dropdown-item" href="{{ route('vacancy.notices') }}">पदपूर्ति सूचना</a></li>
                            <li><a class="dropdown-item" href="{{ route('vacancy.exam-schedule') }}">परीक्षा कार्यक्रम</a></li>
                            <li><a class="dropdown-item" href="{{ route('vacancy.results') }}">नतिजा</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->routeIs('faq') || request()->routeIs('gallery') || request()->routeIs('videos') || request()->routeIs('important-links') || request()->routeIs('sitemap') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown">
                            थप <i class="fas fa-chevron-down ms-1" style="font-size: 10px;"></i>
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ route('faq') }}">FAQ</a></li>
                            <li><a class="dropdown-item" href="{{ route('gallery') }}">फोटो ग्यालरी</a></li>
                            <li><a class="dropdown-item" href="{{ route('videos') }}">भिडियो ग्यालरी</a></li>
                            <li><a class="dropdown-item" href="{{ route('important-links') }}">महत्वपूर्ण लिंकहरू</a></li>
                            <li><a class="dropdown-item" href="{{ route('sitemap') }}">वेबसाइट नक्सा</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <div class="row align-items-center">
                ...
                <div class="col notice-ticker">
                    <marquee behavior="scroll" direction="left" onmouseover="this.stop()" onmouseout="this.start()">
                        ...
                        <span class="mx-3">{{ $notice->title }}</span>
                        @endforeach
                    </marquee>
                </div>
                <div class="col-auto">
                    <a href="{{ route('notices') }}" class="view-all">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 footer-section">
                    <h4>हाम्रो बारेमा</h4>
                    <p>{{ Setting::get('tagline_np', 'स्वच्छ पानी, स्वस्थ जीवन') }}</p>
                    <p class="small">{{ Setting::get('site_name_np', 'गुन्जनगर खानेपानी आयोजना') }} ले गुन्जनगरवासीहरूलाई गुणस्तरीय खानेपानी उपलब्ध गराउनु हाम्रो प्रमुख लक्ष्य हो।</p>
                    <div class="social-icons mt-3">
                        @if(Setting::get('facebook_url'))
                        <a href="{{ Setting::get('facebook_url') }}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                        @endif
                        @if(Setting::get('twitter_url'))
                        <a href="{{ Setting::get('twitter_url') }}" target="_blank"><i class="fab fa-twitter"></i></a>
                        @endif
                        @if(Setting::get('youtube_url'))
                        <a href="{{ Setting::get('youtube_url') }}" target="_blank"><i class="fab fa-youtube"></i></a>
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-3 footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('about') }}"><i class="fas fa-chevron-right me-2"></i>हाम्रो बारेमा</a></li>
                        <li><a href="{{ route('services') }}"><i class="fas fa-chevron-right me-2"></i>सेवाहरू</a></li>
                        <li><a href="{{ route('notices') }}"><i class="fas fa-chevron-right me-2"></i>सूचना</a></li>
                        <li><a href="{{ route('downloads') }}"><i class="fas fa-chevron-right me-2"></i>डाउनलोड</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 footer-section">
                    <h4>सेवाहरू</h4>
                    <ul>
                        <li><a href="{{ route('services.new-connection') }}"><i class="fas fa-chevron-right me-2"></i>नयाँ धारा जडान</a></li>
                        <li><a href="{{ route('services.transfer') }}"><i class="fas fa-chevron-right me-2"></i>धारा स्थानान्तरण</a></li>
                        <li><a href="{{ route('services.maintenance') }}"><i class="fas fa-chevron-right me-2"></i>मर्मत सेवा</a></li>
                        <li><a href="{{ route('services.water-quality') }}"><i class="fas fa-chevron-right me-2"></i>गुणस्तर परीक्षण</a></li>
                        <li><a href="{{ route('contact') }}"><i class="fas fa-chevron-right me-2"></i>सम्पर्क गर्नुहोस्</a></li>
                    </ul>
                </div>
                ...
                <div class="col-md-3 footer-section">
                    <h4>सम्पर्क</h4>
                    <ul>
                        <li><i class="fas fa-map-marker-alt me-2"></i>{{ Setting::get('office_address', 'गुन्जनगर, नेपाल') }}</li>
                        <li><i class="fas fa-phone me-2"></i>{{ Setting::get('contact_phone', '') }}</li>
                        <li><i class="fas fa-envelope me-2"></i>{{ Setting::get('contact_email', '') }}</li>
                        <li><i class="fas fa-clock me-2"></i>{{ Setting::get('office_hours_weekdays', '10:00 AM - 5:00 PM') }}</li>
                    </ul>
                </div>
            </div>
            
            <div class="footer-bottom">
                <p>© 2082 {{ Setting::get('site_name_np', 'गुन्जनगर खानेपानी आयोजना') }} । सर्वाधिकार सुरक्षित ।</p>
