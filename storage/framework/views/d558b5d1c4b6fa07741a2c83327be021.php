...
<?php $__env->startSection('page-title', 'नयाँ स्लाइडर सिर्जना गर्नुहोस्'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-control" name="show_overlay">
                        <option value="1" <?php echo e(old('show_overlay') ? 'selected' : ''); ?>>Yes</option>
                        <option value="0" <?php echo e(old('show_overlay') ? '' : 'selected'); ?>>No</option>
                    </select>
                </div>
                <div class="col-md-4 mb-3">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\CascadeProjects\gunjannagar-khanepani\resources\views/admin/sliders/create.blade.php ENDPATH**/ ?>